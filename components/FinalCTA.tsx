  ...
  return (
    <section className="border-t border-line px-7 pb-30 pt-25 md:pb-32 md:pt-28 text-center">
      <div className="mx-auto max-w-[1180px]">
        <h2 className="mx-auto mb-5 max-w-[16ch] text-[clamp(36px,5.5vw,64px)] font-semibold leading-[1.05] tracking-[-0.035em]">
          Be among the first <em className="italic font-medium text-accent">500</em>.
        </h2>
